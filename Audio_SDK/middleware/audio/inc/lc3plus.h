...
// ---------- ZHAO YING added the following APIs for convenience -----
/*! Get bitrate of the encoder
 *
 *  \param[in]  encoder     Encoder handle.
 *  \return                 Bitrate in bits per second or 0 on error.
 */
int lc3plus_enc_get_bitrate(const LC3PLUS_Enc *encoder);

/*! Get error protection mode of the encoder
 *
 *  \param[in]  encoder     Encoder handle.
 *  \return                 Error protection mode.
 */
int lc3plus_enc_get_ep_mode(const LC3PLUS_Enc *encoder);

/*! Get bandwidth of the encoder
 *
 *  \param[in]  encoder     Encoder handle.
 *  \return                 bandwidth in Hz.
 */
int lc3plus_enc_get_bandwidth(const LC3PLUS_Enc *encoder);
