 ...
 * @return None
 */
void eq_init(EQContext* eq, int32_t sample_rate, EQFilterParams* filter_params, uint32_t filter_count, int32_t pregain, int32_t num_channels);
 ...
 * @return None
 */
void eq_init_float(EQContext* eq, int32_t sample_rate, EQFilterParams* filter_params, uint32_t filter_count, int32_t pregain, int32_t num_channels);
 ...
 * @return NONE
 */
void eq_configure_filters(EQContext* eq, int32_t sample_rate, EQFilterParams* filter_params, uint32_t filter_count);
 ...
 * @param  pcm_in Address of the PCM input buffer. The PCM layout for mono is like "M0,M1,M2,..." and for stereo "L0,R0,L1,R1,L2,R2,...".
 * @param  pcm_out Address of the PCM output buffer. The PCM layout for mono is like "M0,M1,M2,..." and for stereo "L0,R0,L1,R1,L2,R2,...".
 *         pcm_out CANNOT be the same as pcm_in. pcm_out is a pointer to a 32-bit array where each PCM value occupies 32-bit in Qx.15 format.
 * @param  n  Number of PCM samples to process.
 * @return NONE
 */
