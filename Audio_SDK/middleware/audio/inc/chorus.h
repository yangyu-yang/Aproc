...
#define MAX_CHORUS_DELAY_SAMPLES (25*2*48+2) // maximum delay in samples 25ms*2@48kHz
...
* @param mod_depth Modulation depth in millisecond, which should be no more than delay_length. Range: 0~delay_length ms
