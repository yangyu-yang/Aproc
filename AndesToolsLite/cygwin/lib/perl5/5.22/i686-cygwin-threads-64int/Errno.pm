...
"cygwin-thread-multi-64int-2.5.1(0.29753)" or
	die "Errno architecture (cygwin-thread-multi-64int-2.5.1(0.29753)) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
